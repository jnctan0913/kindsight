...
export const BriefingScreen: React.FC = () => {
      ...
      {Array.from({length: SLIDE_COUNT}).map((_, i) => (
        <div
          ...
          style={{
            ...
            borderRadius: 4,
            backgroundColor:
              index === i ? 'var(--main-color)' : 'var(--border-color)',
  ...
  const renderSlide1 = () => (
    <>
      ...
      />
      <h2 style={{marginTop: 12, textAlign: 'center'}}>
        {t('player.briefing.slide1.title')}
      </h2>
      <p
        className='t16'
      ...
      <div style={cardStyle}>
        ...
        <p
          className='t14'
          style={{marginTop: 4, textDecoration: 'line-through'}}
        >
        ...
        <p
          className='t14'
          style={{marginTop: 4, color: 'var(--main-color)'}}
        >
  ...
  const renderSlide2 = () => (
    <>
      <img
        src={asset('/assets/kindsight/onboarding-rotate-transparent.png')}
        alt=''
        aria-hidden='true'
        style={illustrationStyle}
      />
      <h2 style={{marginTop: 12, textAlign: 'center'}}>
        {t('player.briefing.slide2a.title')}
      </h2>
      <p
        className='t16'
        style={{marginTop: 8, textAlign: 'center'}}
      >
        {t('player.briefing.slide2a.body')}
      </p>
    </>
  );
  ...
  const renderSlide3 = () => (
    <>
      ...
      />
      <h2 style={{marginTop: 12, textAlign: 'center'}}>
        {t('player.briefing.slide3.title')}
      </h2>
      <p
        className='t16'
        style={{marginTop: 8, textAlign: 'center'}}
