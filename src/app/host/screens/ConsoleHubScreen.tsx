    ...
    <div>
      ...
      >
        <div style={cardStyle}>
          ...
          <p className='t14'>{t('host.hub.start.body')}</p>
          <components.Button
        ...
        <div style={cardStyle}>
          ...
          {activeRooms.length === 0 ? (
            <p className='t12' style={{marginTop: 8, color: 'var(--text-color)'}}>
