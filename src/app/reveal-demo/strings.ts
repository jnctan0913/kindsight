export const strings = {
  ...
  'reveal.hold.in': 'Breathe in...',
  'reveal.hold.out': 'Breathe out...',
  ...
  'reveal.note.counter': 'Note {n} of {count}',
  'reveal.note.aria': '{frame} note: {text}',
  'reveal.optin.question': 'Share this one to the big screen wall?',
  'reveal.optin.no': 'No',
  'reveal.optin.share': 'Share',
  'reveal.optin.shared': 'Shared',
  'reveal.optin.aria':
    'Share this note to the big screen wall, currently not shared',
  'reveal.next': 'Next note',
  'reveal.last': 'See your whole wall',
